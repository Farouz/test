...
<div id="wrapper">
    <header>
        <section id="top-area">
            <p>Phone orders:+2011103956253 mail us: <a href="mailto:hossamfarouz15@gmail.com">hossamfarouz15@gmail.com</a></p>
        ...
        <section id="action-bar">
            ...
            <div id="user-menu">
                ...
                <nav class="dropdown">
                    <ul>
                        <li>
                            <a href="#"><img src="img/user-icon.gif" alt="Andrew Perkins" /> {{Auth::user()->name}} <img src="img/down-arrow.gif" alt="Andrew Perkins" /></a>
                            <ul>
...
@endif
    ...
    <footer>
        <section id="contact">
            <h3>For phone orders please call +201110396253. You<br>can also email us at
                <a href="mailto:office@shop.com">hossamfarouz15.com</a></h3>
        </section><!-- end contact -->
        ...
        <section class="clearfix">
            <div id="copyright">
                ...
                <p id="store-copy">&copy; 2017 eCommerce. Developed by Hossam Farouz.</p>
            </div><!-- end copyright -->
            <div id="connect">
